...
void Pixhawk_Interface::read_msg()
{
...
void Pixhawk_Interface::get_home_pos()
{
    mavlink_message_t msg;
...
void Pixhawk_Interface::set_target_alt(int alt)
{
    mavlink_message_t msg;
...
// ----------------------------------------------------------------------------
void Pixhawk_Interface::write_RC_command(int roll, int thr, int yaw)
{
	mavlink_message_t msg;
...
//	Arming the quad
// ----------------------------------------------------------------------------
void Pixhawk_Interface::arm_quad(mavlink_message_t msg, int arm)
{
...
int Pixhawk_Interface::update_arm_status()
{
    // arm status: 0 = disarm, 1 = arm
